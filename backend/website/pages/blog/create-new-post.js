...
export default function CreateNewPost({}) {
    ...
    const [imageUrlInputValue, setImageUrlInputValue] = useState("optional");
    const [markdownInputValue, setMarkdownInputValue] = useState("");
    const [seoTitleTagInputValue, setSeoTitleTagInputValue] = useState("optional");
    const [seoTitleTagCharLeft, setSeoTitleTagCharLeft] = useState(60);
    const [metaDescriptionInputValue, setMetaDescriptionInputValue] = useState("optional");
                    ...
                    <div className="create-blog-post-form-container">
                        <div className="create-blog-post-form-section">
                            ...
                            <div className="create-blog-post-form-section-input">
                                <input type="text" value={titleInputValue} onChange={updateTitleInputValue} placeholder="Title must be unique" />
                                <span
                        ...
                        <div className="create-blog-post-form-section">
                            ...
                            <div className="create-blog-post-form-section-input">
                                <input type="text" value={tagsInputValue} onChange={updateTagsInputValue} placeholder="Enter tags seperated by `,`" />
                            </div>
                        </div>
                        <div className="create-blog-post-form-section">
                            <div className="create-blog-post-form-section-label">
